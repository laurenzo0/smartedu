        ...
        <Navbar/>
            ...
            <div className="subject-section">
                <div className="box eng-lang">
                    ...
                    <button className="eng-btn">Take a full test <i className="fa-solid fa-pen"></i></button>
                </div>
                <div className="box maths">
                    <img src="src/assets/images/confused student.jpeg" alt="confused student" className="math-img" />
                    <h2>Mathematics</h2>
                    <button className="math-btn">Take a full test <i className="fa-solid fa-pen"></i></button>
                </div>
                <div className="box comp-sci">
                    <img src="src/assets/images/purple big guy.jpeg" alt="purple big guy" className="comp-img" />
                    <h2>Computer Science</h2>
                    <button className="comp-btn">Take a full test <i className="fa-solid fa-pen"></i></button>
                </div>
            </div>
